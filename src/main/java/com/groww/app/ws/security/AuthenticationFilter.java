...
import com.groww.app.ws.SpringApplicationContext;
import com.groww.app.ws.service.UserService;
import com.groww.app.ws.shared.dto.UserDto;
import com.groww.app.ws.ui.model.request.UserLoginRequestModel;
...
private final AuthenticationManager authenticationManager;
    ...
    protected void successfulAuthentication(HttpServletRequest req,
        ...
        UserDto userDto = userService.getUser(userName,(Objects.equals(req.getParameter("type"), "user") ? USER:CARETAKER));
